...
export default function Hero() {
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center md:text-left px-4 md:px-8">
        <h2 className="text-5xl font-bold mb-4 text-[#FCFDAF] leading-tight animate__animated animate__fadeIn animate__delay-1s">
          Bienvenido a <br /> El Rincón del Grano
        </h2>
